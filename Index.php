...
<html>
<head>
	<title>Online Library Management SystemS</title>
...
<body>
	<div class="wrapper">
		<header >
			<div class="logo">
				<img src="Images/Logo_L.png"style="padding-left: 80px;margin-top: 10px;height: 60px;width: 150px;" >
		...
		<section style="height: 650px; background-image:url(Images/Index_B.jpg);margin-top: -20px; ">
			<div>
