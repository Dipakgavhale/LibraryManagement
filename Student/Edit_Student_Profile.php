...
<html>
<head>
	<title>Edit Studennt Profile</title>
	<style type="text/css">
		.form-control
		{
			width: 250px;
...
<body style="background-color:#004528;">
	<h2 style="text-align: center;color: #fff;">Edit Student Information</h2>
	<?php
	...
	<div class="profile_info" style="text-align: center;">
		...
		<h4 style="color: white;"><?php echo $_SESSION['login_user']; ?></h4><br>
		<div class="form1">
		<form action="" method="post" enctype="multipart/form-data">
			...
			{
				move_uploaded_file($_FILES['file']['tmp_name'], "Student_Images/".$_FILES['file']['name']);
				$first=$_POST['first'];
				$last=$_POST['last'];
				$email=$_POST['email'];
				$mobile=$_POST['mobile'];
				...
				$sqli="UPDATE registration SET pic='$pic',first='$first',last='$last',email='$email',mobile='$mobile',username='$username',password='$password' where username='".$_SESSION['login_user']."';";
				if (mysqli_query($db,$sqli)) 
				{
					?>
					<script type="text/javascript">
						alert("Saved Successfully.")
						window.location="Profile_S.php";
					</script>
					<?php
				}
			}
