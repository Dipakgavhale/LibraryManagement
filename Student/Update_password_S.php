...
<head>
	...
	<style type="text/css">
		body
		{
			...
			background-image: url("Student_Images/Student_Updatepassword_B.jpg");
...
<div class="wrapper">
	...
	<div style="padding-left: 30px;">
		<form action="" method="post">
			...
			<input type="text" name="email" class="form-control" placeholder="Email ID" required=""><br><br>
...
{
	if(mysqli_query($db,"UPDATE registration SET password='$_POST[password]' WHERE username='$_POST[username]'AND email ='$_POST[email]' ;"))
	{
		?>
		<script type="text/javascript">
			alert("The Password Updated Successfu.");
		</script>
