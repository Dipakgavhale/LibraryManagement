...
<head>
	...
	<style type="text/css">
		...
		body 
		{
		  background-image: url("Admin_Images/Expired_Book_List_B.jpg");
				...
				if (isset($_SESSION['login_user'])) 
				{
					...
					<div class="srch"><br>
						<form method="post" action="" name="form1">
							<input type="text" name="username" class="form_control" placeholder="Username" required=""><br><br>
							<input type="text" name="B_ID" class="form_control" placeholder="Book ID" required=""><br><br>
					...
					{
						$res=mysqli_query($db,"SELECT * FROM `issue_book` WHERE User_Name='$_POST[username]' and B_ID='$_POST[B_ID]'; ");
						...
						$x=date("Y-m-d");
						mysqli_query($db,"INSERT INTO `fines` VALUES ('$_POST[username]', '$_POST[B_ID]', '$x', '$day', '$fine','Not paid');");
						$var1='<p style="color:yellow;background-color:green;">Returned</P>';
						mysqli_query($db,"UPDATE issue_book SET Approve='$var1' where User_Name='$_POST[username]' and B_ID='$_POST[B_ID]' ");
